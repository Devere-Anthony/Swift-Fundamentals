 ...
 */
let friends = 50
print("You currently have \(friends) in playgrounds.")
...
print("""
    The above code doesn't compile. Ofc, you're attempting to change the value of a constant which is a no go in any language.
""")
